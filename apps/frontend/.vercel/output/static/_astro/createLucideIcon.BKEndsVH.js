import { r as s } from './index.CqJmc5Mb.js';
/**
 ...
 */ const C = (t) => t.replace(/([a-z0-9])([A-Z])/g, '$1-$2').toLowerCase(),
  w = (t) => t.replace(/^([A-Z])|[\s-_]+(\w)/g, (e, r, o) => (o ? o.toUpperCase() : r.toLowerCase())),
  i = (t) => {
    const e = w(t);
 ...
 */ const g = s.forwardRef(
  (
    ...
    s.createElement(
      ...
      [...u.map(([m, d]) => s.createElement(m, d)), ...(Array.isArray(a) ? a : [a])]
    )
);
/**
 * @license lucide-react v0.522.0 - ISC
 ...
 */ const b = (t, e) => {
  const r = s.forwardRef(({ className: o, ...n }, a) =>
    s.createElement(g, { ref: a, iconNode: e, className: l(`lucide-${C(i(t))}`, `lucide-${t}`, o), ...n })
  );
