...
function F() {
  ...
  function g(t, e, r, n, s, i) {
    return ((r = i.ref), { $$typeof: p, type: t, key: e, ref: r !== void 0 ? r : null, props: i });
  }
  function K(t, e) {
    ...
    if (u)
      return (
        ...
        N(s)
          ...
          : s != null &&
            (w(s) &&
              (s = K(s, r + (s.key == null || (t && t.key === s.key) ? '' : ('' + s.key).replace(M, '$&/') + '/') + u)),
            e.push(s)),
        1
      );
    u = 0;
    var a = n === '' ? '.' : n + ':';
    if (N(t)) for (var c = 0; c < t.length; c++) ((n = t[c]), (i = a + A(n, c)), (u += E(n, e, r, i, s)));
    else if (((c = G(t)), typeof c == 'function'))
      for (t = c.call(t), c = 0; !(n = t.next()).done; ) ((n = n.value), (i = a + A(n, c++)), (u += E(n, e, r, i, s)));
    else if (i === 'object') {
  ...
  return (
    ...
    (o.createContext = function (t) {
      return (
        (t = { $$typeof: x, _currentValue: t, _currentValue2: t, _threadCount: 0, Provider: null, Consumer: null }),
        (t.Provider = t),
    ...
    (o.startTransition = function (t) {
      ...
      try {
        var n = t(),
          s = f.S;
        (s !== null && s(r, n), typeof n == 'object' && n !== null && typeof n.then == 'function' && n.then(X, I));
      } catch (i) {
        I(i);
      } finally {
        f.T = e;
...
export { rt as R, et as a, tt as b, V as g, U as r };
