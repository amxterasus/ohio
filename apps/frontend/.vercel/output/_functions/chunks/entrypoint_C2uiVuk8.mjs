import {
  ...
  G as LocalsNotAnObject,
  H as REROUTABLE_STATUS_CODES,
  J as responseSentSymbol,
...
import {
  ...
  c as collapseDuplicateTrailingSlashes,
  h as hasFileExtension,
} from './path_BuZodYwm.mjs';
import {
  r as requestIs404Or500,
  i as isRequestServerIsland,
  n as notFound,
  a as redirectToFallback,
  b as redirectToDefaultLocale,
  c as requestHasLocale,
  e as normalizeTheLocale,
  f as defineMiddleware,
  S as SERVER_ISLAND_COMPONENT,
  h as SERVER_ISLAND_ROUTE,
  j as createEndpoint,
  R as RouteCache,
  s as sequence,
  k as findRouteToRewrite,
  m as matchRoute,
  l as RenderContext,
  P as PERSIST_SYMBOL,
  o as getSetCookiesFromResponse,
} from './server_dmvpSWTn.mjs';
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_SViUe73y.mjs';
...
class AppPipeline extends Pipeline {
  static create({ logger, manifest, runtimeMode, renderers, resolve, serverLike, streaming, defaultRoutes }) {
...
class App {
  ...
  #mergeResponses(newResponse, originalResponse, override) {
    ...
    const mergedHeaders = new Map([...Array.from(newResponseHeaders), ...Array.from(originalResponse.headers)]);
